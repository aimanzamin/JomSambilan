 ...
 <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                 <h2 class="page-header">Tambah Pekerja Baru</h2>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <div class="col-lg-5">
                          ...
                          <div class="col-lg-4">
                            <div class="radio">
                              <label><input id="optionsRadios2"   name="optionsRadios" type="radio" value="Male"> Lelaki</label>
                            </div>
                          </div> 
                         ...
                         <div class="form-group">
                              <div class="rows">
                                <div class="col-md-8">
                                  <h4>
                                  <div class="col-md-4">
                                    <label class="col-lg-12 control-label">Tarikh Lahir</label>
                                  </div>
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "CIVILSTATUS">Status Perkahwinan:</label>
                                ...
                                <div class="col-md-8">
                                  <select class="form-control input-sm" name="CIVILSTATUS" id="CIVILSTATUS">
                                      ...
                                      <option value="Widow" >Duda/Janda</option>
                        ...
                        <!--     <div class="form-group">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "EMP_HIREDDATE">Tamat Khidmat:</label> 
                                <div class="col-md-8">
                             ...
                             <div class="form-group">
                                <div class="col-md-8">
                                  <label class="col-md-4 control-label" for=
                                  "COMPANYNAME">Nama Syarikat:</label>
