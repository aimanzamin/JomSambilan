...
<div class="col-sm-12 content-header" style="">Lihat Butiran</div>
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-12"> 
		<p>Kelayakan / Pengalaman Kerja : </p>
...
<p><i class="fa fa-paperclip"></i>  Fail Lampiran</p>
	<div class="col-sm-12 slider">
		 <h3>Muat turun Resume <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Here</a></h3>
	</div> 
