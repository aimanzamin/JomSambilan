    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">Halaman Utama</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company">Syarikat</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">Pengambilan Pekerja</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About">Tentang Kami</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=Contact">Hubungi Kami</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
