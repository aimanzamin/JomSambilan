    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo web_root; ?>plugins/jobportal/images/g1.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
            <p class="mb-4 mt-5 pt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Kami ada <span class="number" data-number="850000">0</span> pekerjaan hebat menawarkan anda layak!</p>
            <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Impian kamu<br><span>Sedang Menunggu</span></h1>
                          ...
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                ...
                                <input type="text"  name="SEARCH" class="form-control" placeholder="cth. Guru bahasa. Mekanik">
                              </div>
                            </div>
                          </div>
                          <div class="col-md">
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Cari Jutaan Pekerjaan</h3>
                <p>Sebuah sungai kecil bernama Duden mengalir di tempat dan bekalan mereka.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Mudah Diuruskan Pekerjaan</h3>
                <p>Sebuah sungai kecil bernama Duden mengalir di tempat dan bekalan mereka.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Kerjaya Teratas</h3>
                <p>Sebuah sungai kecil bernama Duden mengalir di tempat dan bekalan mereka.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Cari Calon Pakar</h3>
                <p>Sebuah sungai kecil bernama Duden mengalir di tempat dan bekalan mereka.</p>
              </div>
            </div>      
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">Kategori pekerjaan menanti anda</span>
            <h2 class="mb-4"><span> Semasa </span>Jawatan Kerja</h2>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4"><span>Pekerjaan</span>Terkini</h2>
          </div>
        </div>
        <div class="row">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">Jauh di belakang kata gunung, jauh dari negara Vokalia dan Consonantia, terdapat teks-teks yang buta.</p>
